<template>
  <div class="about">
    <div
      v-if="pokemon"
      className="w-1/5 m-auto p-10 bg-gray-100 mt-10 shadow-md flex justify-center flex-col items-center rounded border-dashed border-2 border-light-blue-500"
    >
